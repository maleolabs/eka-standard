...
This specification is the versioned snapshot of the EKA Standard 1.2 — an
immutable normative specification. Version 1.2 is frozen; it is never edited
in place.
...
| Axis                        | Value                           | Notes                  |
| --------------------------- | ------------------------------- | ---------------------- |
| Standard corpus version     | 1.2                           | this specification     |
