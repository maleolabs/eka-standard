...
This specification is the versioned snapshot of the EKA Standard 1.0.0 — an
immutable normative specification. Version 1.0.0 is frozen; it is never edited
in place.

## Versioning rules (semantic)

- **1.0.0** — initial stable EKA Standard. Immutable.
...
| Axis                        | Value                           | Notes                  |
| --------------------------- | ------------------------------- | ---------------------- |
| Standard corpus version     | 1.0.0                           | this specification     |
